...
/**
 * http://blog.csdn.net/ccy0122/article/details/53241648#reply
 * Created by ly on 2016/11/30.
 */

public class ZhiMaXinYong extends View {
    ...
    /**
     * 圆弧的开始角度，从水平向右的方向为0度，顺时针的方向扫过的方向就是角度
     */
    private int startAngle;
    /**
     * 扫过的角度，顺时针的方向扫，在开始的角度基础上进行旋转
     */
    ...
    public ZhiMaXinYong(Context context) {
        this(context, null);
    }

    public ZhiMaXinYong(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZhiMaXinYong(final Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * http://m.blog.csdn.net/article/details?id=50776507,旋转
     *
     * @param canvas
     */
...
//        paint.getTextBounds(text,0,text.length(),rect);
    ...
    private void drawRound(Canvas canvas) {
        ...
        //由于画布原点在view的中心点，所以矩形的左上角和右下角的坐标变了
